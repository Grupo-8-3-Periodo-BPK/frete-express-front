...
// --- Componente Principal do Perfil do Cliente (Ajustado) ---
function ClientProfile() {
  ...
  const formatCpfCnpj = (value) => {
    ...
    const cleanedValue = String(value).replace(/\D/g, ""); // Remove tudo que não é dígito
              ...
              <>
                <div className={`relative rounded-2xl shadow-xl overflow-visible transition-colors duration-300 ${darkMode ? "bg-gray-800" : "bg-white"}`}>
                  ...
                  <div className="pt-20 pb-6 px-6 text-center">
                    ...
                    <p className="text-md font-semibold text-blue-500 capitalize mt-1">
                    ...
                    {activeTab === 'received' && (
                       <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
                         {receivedReviews.length > 0 ? receivedReviews.map((review) => (
                           <ReviewCard key={review.id} review={review} viewType="received" perspective="CLIENT" />
                    ...
                    {activeTab === 'made' && (
                      <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
                         {madeReviews.length > 0 ? madeReviews.map((review) => (
                           <ReviewCard key={review.id} review={review} viewType="made" perspective="CLIENT" />
